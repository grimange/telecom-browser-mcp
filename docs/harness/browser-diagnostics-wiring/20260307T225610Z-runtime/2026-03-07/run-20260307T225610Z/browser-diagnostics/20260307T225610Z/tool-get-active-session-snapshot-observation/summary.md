...
- run_id: run-20260307T225610Z
- scenario_id: tool-get-active-session-snapshot-observation
- session_id: sess_408c0d1332
- fault_type: tool_observation
- injection_point: get_active_session_snapshot
- status: ok
