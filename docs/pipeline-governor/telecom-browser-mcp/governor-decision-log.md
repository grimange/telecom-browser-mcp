...
- state: live-verification-blocked
- global_verdict: blocked_by_live_verification
- recommended_global_action: remediate_live_verification_blockers
- conflict_count: 0
- runtime_transport_classification: sandbox_only_execution_blocker
- stability_verdict: stable_with_risks
