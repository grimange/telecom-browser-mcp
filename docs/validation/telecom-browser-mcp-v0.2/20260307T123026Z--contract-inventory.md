# Contract Inventory (20260307T123026Z)
...
Ambiguous contracts:
- minimum accepted depth for `diagnose_one_way_audio`
- protocol PASS criteria for host-level interop in this environment
