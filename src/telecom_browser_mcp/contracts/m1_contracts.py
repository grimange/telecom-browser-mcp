...
M1_TOOL_INPUT_MODELS: dict[str, type[BaseModel]] = {
    ...
    "hangup_call": TimeoutInput,
    "get_registration_status": SessionInput,
    "get_active_session_snapshot": SessionInput,
    "get_store_snapshot": SessionInput,
    "get_peer_connection_summary": SessionInput,
    "collect_debug_bundle": CollectDebugBundleInput,
    "diagnose_answer_failure": SessionInput,
}

SUPPORT_TOOL_INPUT_MODELS: dict[str, type[BaseModel]] = {
    "health": EmptyInput,
    "capabilities": EmptyInput,
}

CANONICAL_TOOL_INPUT_MODELS: dict[str, type[BaseModel]] = {
    **SUPPORT_TOOL_INPUT_MODELS,
    **M1_TOOL_INPUT_MODELS,
}
...
def generate_all_tool_schemas() -> dict[str, dict]:
    schemas: dict[str, dict] = {}
    response_schema = ToolResponse.model_json_schema()
